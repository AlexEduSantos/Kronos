  ...
  return (
    <div className="w-full h-20 flex items-center px-6 justify-between">
      <div className="flex items-center gap-4 rounded-full bg-primary/30 p-1">
        ...
        <Button className="aspect-square w-10 h-10 rounded-full ">
          <CalendarDaysIcon />
        </Button>
      </div>
      <div className="flex items-center gap-4">
        <span className="w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center overflow-hidden">
