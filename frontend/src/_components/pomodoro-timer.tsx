    ...
    >
      <div className="flex items-center gap-2">
        <Switch
          ...
          className="rotate-90 data-[state=unchecked]:bg-primary data-[state=checked]:bg-accent"
        />
      ...
      <div className="flex items-center gap-2">
        <div className="flex flex-col items-center gap-2">
          ...
          <Button
            className={`w-full font-light flex items-center gap-1 ${
              modo === "study" ? "" : "bg-accent"
            }`}
            onClick={() => {
              setIsActive(false);
        ...
        <div className="relative w-[100px] h-[100px]">
          ...
          >
            <circle
              ...
              cy="50"
              r="45"
              stroke={`${modo === "study" ? "#3c83f6" : "#00FF00"}`}
              strokeWidth="1"
              fill="none"
              opacity={0.3}
            />
